package com.example.c.firebase;
...
import com.example.c.activities.chatActivity;
...
public class MessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(@NonNull RemoteMessage message) {
        ...
        User user =new User();
        user.id = message.getData().get(Constants.KEY_USER);
        ...
        builder.setContentTitle(message.getData().get(Constants.KEY_MESSAGE));
